document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    // Obtenemos y mostrar los comentarios del producto
    ...
    commentForm.addEventListener("submit", (event) => {
      ...
      // Aquí puedes realizar acciones con el comentario y la calificación,
      // como mostrarlos en la página o enviarlos al servidor (no implementado en este ejemplo)
